  ...
  return (
    <Box>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Fastrash, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Google Developer Student Clubs FUTO,
            Owerri, Imo state.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Fastrash, accessible from{" "}
            <Link to="https://fastrash.vercel.app/">Website</Link>
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        close Your web browser. You can learn more about cookies on article.
      </p>
      <p>
      ...
      <ul>
        <li>By email: dscfuto@gmail.com</li>
      </ul>
    </Box>
  );
}
