...
const Education = () => {
    ...
    <Box ref={educationRef} id='educationContainer' w='100%' h='100%' mt='30px'>
      <Flex justifyContent="center" alignItems="center" pt="60px" w='100%'>
      <Heading fontSize={{ base: '35px', md: '60px', lg: '80px' }} color='#111210'>Did <span style={{ color: useColors.appYellow }}>you </span> know</Heading>
      <Image src={TagImage} alt='TagImage' fontSize={{base: '5%' , md: '50%', lg: '100%'}}/>
      </Flex>
      ...
      >
        ...
        <SwiperSlide className='Card-Swiper'>
          <Box>
            <Text fontSize='18px' textAlign='initial'>Waste reduction, recycling and reuse are important waste management strategies that eases the burden on landfills, 
            ...
            <Image src={CardImage1} alt='CardImage' w='100%' h='400px' mt='20px' objectFit='cover'/>
            </Box>
        </SwiperSlide>
        <SwiperSlide className='Card-Swiper'>
          <Box>
            ...
            <Image src={CardImage2} alt='CardImage' w='100%' h='400px' objectFit='cover' mt='20px'/>
            </Box>
        </SwiperSlide>
        <SwiperSlide className='Card-Swiper'>
          <Box>
            ...
            <Image src={CardImage3} alt='CardImage' w='100%' h='400px' objectFit='cover' mt='20px'/>
            </Box>
        </SwiperSlide>
        <SwiperSlide className='Card-Swiper'>
          <Box>
            ...
            <Image src={CardImage4} alt='CardImage' w='100%' h='400px' objectFit='cover' mt='20px'/>
            </Box>
        </SwiperSlide>
