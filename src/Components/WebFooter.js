...
const WebFooter = () => {
    return (
        <Box w='100%' bg='#111210'flexDirection={{ base: 'column', md: 'row', lg: 'row' }} color='#fff' mt='50px' p={{base: '10px', md: '20px', lg: '50px'}} display='flex' alignItems='center' justifyContent='center'>
            ...
            <ReachLink to="/">FASTHRASH</ReachLink>
            </Box>
            ...
            <Box width={{base: '100%', md: '50%', lg: '25%'}}>
                ...
                <Button width={{base: '30%', md: '40%', lg: '100px'}} fontSize={{base: '12px', lg: '16px'}} alignSelf={{base: 'center',lg: 'initial'}} ml='10px' mt={{base: '10px' , lg: '0px'}} borderRadius='7px' style={{ background: useColors.appYellow }}>Subscribe</Button>
                </Flex>
